...
-- RemoveDefault: target_type (SQLite does not support ALTER COLUMN)
...
INSERT INTO "new_ChatSession" ("claude_session_id", "command", "created_at", "custom_prompt", "id", "last_used_at", "project_id", "scope_target_id", "scope_type", "target_number", "target_type", "title", "updated_at") SELECT "claude_session_id", "command", "created_at", "custom_prompt", "id", "last_used_at", "project_id", "scope_target_id", "scope_type", "target_number", "target_type", "title", "updated_at" FROM "ChatSession";
DROP TABLE "ChatSession";
